...
//            var embeddings = embeddingClient.GenerateEmbeddingsAsync([section.Content.Replace('\r', ' '), new EmbeddingGenerationOptions(embeddingModelName, [section.Content.Replace('\r', ' ')]));
